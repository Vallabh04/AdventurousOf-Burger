...
{
    //enum and states
    public enum StateEnum {Idel,Right,Left,Jump,ForwardJump,BackwardJump};
    ...
    void Update()
    {
        ...
        if (transform.position.x < -4.5)
        {
            --Lives;
            Lifes.text = "Lives : " +Lives.ToString();
            player.transform.position = new Vector3(0, -11.12f, -1);
            if (Lives == 0)
            {
    ...
    { 
        ...
        if(collision.gameObject.CompareTag("inst"))
        {
